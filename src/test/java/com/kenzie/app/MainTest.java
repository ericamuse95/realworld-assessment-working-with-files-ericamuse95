...
public class MainTest {
    ...
    public void testReadCSVFromFile() throws IOException {
        ...
        String expectedFileContents = "Date,DayOfWeek,TempHighF,TempAvgF,TempLowF\r\n"
    ...
    public void testCreateMultidimensionalArray(){
        int numRows = 1;
        int numColumns = 7;
        String fileContents = "Date,DayOfWeek,TempHighF,TempAvgF,TempLowF\n" +
                "2013-12-22,Sunday,56,48,39\n" +
                "2013-12-23,Monday,58,45,32\n" +
                "2013-12-24,Tuesday,61,46,31\n" +
                "2013-12-25,Wednesday,58,50,41\n" +
        ...
        String[] expectedArray = ArrayUtils.remove(fileContents.split("\n"), 0);
        for(int i = 0; i < 7; i++){
